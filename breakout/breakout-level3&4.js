...
function newLevel() {
    ...
    ctx.font = "25px Arial";
    ctx.fillStyle = "#000000";
    ctx.fillText("Level 3", canvas.width - 685, 25);
    return false; 
}
...
function newLevel4() {
    ctx.font = "25px Arial";
    ctx.fillStyle = "#000000";
    ctx.fillText("Level 4", canvas.width - 650, 25);
    return false; 
}
...
function draw(currentTime) {
  ...
  drawLives();
    ...
    if (score < 210) {
      drawExtraBall();
      updateExtraBall();
      extraBallDx = extraBallDx / 1.0000001;
      extraBallDy = extraBallDy / 1.0000001;
    }
